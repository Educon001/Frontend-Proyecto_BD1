   ...
   return (
       ...
       <div style={{display: 'flexbox', justifyContent: 'center'}}>
          <Grid container justifyContent="center" spacing={1}>
             <Carta Tipo="Tabla de Personas" aux="personas"
                    imagen={personas}/>
             <Carta Tipo="Centros De Salud" aux="cs" imagen={centroSalud}/>
             <Carta Tipo="Personal de Salud" imagen={personalDeSalud}
                    aux="ps"/>
          ...
          <Grid container justifyContent="center" spacing={1}>
             ...
             <Carta Tipo="Primera Consulta" aux="consulta9"
                    imagen={vacunados}/>
             <Carta Tipo="Segunda Consulta" aux="consulta2"
                    imagen={vacunados}/>
             <Carta Tipo="Tercera Consulta" aux="consulta3"
                    imagen={vacunados}/>
             <Carta Tipo="Cuarta Consulta" aux="consulta4"
                    imagen={vacunados}/>
          </Grid>
       </div>
