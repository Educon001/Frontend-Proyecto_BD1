          ...
          <div className="body">
             ...
             <form className="form" id="reg-form" onSubmit={cargarDatos}>
                <div className="form-header">
                   <h1 className="form-tittle">R<span>egistro de Centro Salud</span></h1>
                </div>
                ...
                <div className="form-header">
                   <label className="form-label" htmlFor="Address">Addres</label>
                ...
                <div className="form-header">
                   <label className="form-label" htmlFor="id_medico">Cedula del Medico
                      Encargado</label>
                   <input className="form-input"
                ...
                <div className="form-header">
                   <label className="form-label" htmlFor="code_municipio">Codigo del
                      municipio</label>
                   <input className="form-input"
