...
const MedicamentosF = () => {
    ...
    async function cargarDatos(e) {
        e.preventDefault();
        console.log(estado);
        let url = 'http://localhost:4000/medicamento';
        try {
                    ...
                    <form className="form" id="reg-form" onSubmit={cargarDatos}>
                        <div className="form-header">
                            <h1 className="form-tittle"
                                className="form-tittle">R<span>egistro de Medicamento</span>
                            </h1>
                        </div>
                        ...
                        <div className="form-header">
                            ...
                            <input className="form-input" type="text" id="name"
                                   spellCheck="false"
                                   placeholder="Escriba name"
                                   onChange={handleInputChange} name="name"/>
                        </div>

                        <div className="form-header">
                            <label className="form-label"
                                   htmlFor="component">Componente</label>
                            <input className="form-input" type="text" id="component"
                                   spellCheck="false"
                                   placeholder="Escriba componente"
                                   onChange={handleInputChange} name="component"/>
                        </div>
                        <div className="form-header">
                            <label className="form-label"
                            ...
                            <input className="form-input" type="text" id="concentration"
                                   ...
                                   onChange={handleInputChange} name="concentration"/>
                        </div>
