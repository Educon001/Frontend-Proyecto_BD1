...
const SintomasF = () => {
  ...
  async function cargarDatos(e) {
    e.preventDefault();
    console.log(estado);
    let url = 'http://localhost:4000/sintoma';
    try {
      ...
      if (response.status == 400) {
        swet({
          title: 'Warning',
          text: 'No se ha podido registrar el Sintoma',
          icon: 'warning',
          dangerMode: true,
        });
      } else if (200) {
        swet({
          title: 'Registrado',
          text: 'El sintoma fue registrada exitosamente',
          icon: 'success',
          dangerMode: true,
            ...
            <form className="form" id="reg-form" onSubmit={cargarDatos}>
              <div className="form-header">
                <h1 className="form-tittle"
                    className="form-tittle">R<span>egistro de Sintoma</span>
                </h1>
              </div>
              ...
              <div className="form-header">
                ...
                <input className="form-input" type="text" id="description"
                       spellCheck="false"
