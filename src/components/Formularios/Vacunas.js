                ...
                <form id="reg-form" onSubmit={cargarDatos}>
                    ...
                    <div>
                        ...
                        <input type="text" id="lote" spellCheck="false"
                               placeholder="Escriba lote" onChange={handleInputChange}  name='lote'/>
                    </div>
                    <div>
                        <label htmlFor="cantdosis">cantidad dosis</label>
                        <input type="text" id="cantdosis" spellCheck="false"
                               placeholder="Escriba cantidad dosis" onChange={handleInputChange}  name='cantdosis'/>
                    </div>
                    <div onChange={handleInputChange}>
                        <h4>Tipo</h4>
                        <input type="radio" value="ARNm" name="type" /> ARNm
                        <input type="radio" value="Vector viral" name="type" /> Vector viral
                        <input type="radio" value="Subunidades proteicas" name="type" /> ARNm

                    </div>
                    <div>
                        <label htmlFor="laboratory">Laboratorio</label>
                        <input type="text" id="laboratory" spellCheck="false"
                               placeholder="Escriba Laboratorio" onChange={handleInputChange}  name='laboratory'/>
                    </div>
                    <div>
                        <label htmlFor="code_pais">Codigo Pais</label>
                        <input type="text" id="code_pais" spellCheck="false"
                               placeholder="Escriba Codigo del Pais" onChange={handleInputChange}  name='code_pais'/>
                    </div>
