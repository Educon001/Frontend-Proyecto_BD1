...
function Vacuna() {
    ...
    const modificar = async (dat) => {
        let result = await funciones.modificarFila('vacuna/' + dat.code, modificable)
        return result
    }
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                {modifi != null && modifi.code == dato.code ?
                                                    <input onChange={handleChangeModifi} type="text" id="name"
                                                           spellCheck="false"
                                                           placeholder={dato['name']}
                                                           name="name"/> : dato['name']}</th>
                                            <th>{modifi != null && modifi.code == dato.code ?
                                                <input onChange={handleChangeModifi} type="text" id="lote"
                                                       spellCheck="false"
                                                       placeholder={dato['lote']}
                                                       name="lote"/> : dato['lote']}</th>
                                            <th>{modifi != null && modifi.code == dato.code ?
                                                <input onChange={handleChangeModifi} type="text" id="cantdosis"
                                                       spellCheck="false"
                                                       placeholder={dato['cantdosis']}
                                                       name="cantdosis"/> : dato['cantdosis']}</th>
                                            <th>{modifi != null && modifi.code == dato.code ?
                                                <input onChange={handleChangeModifi} type="text" id="type"
                                                       spellCheck="false"
                                                       placeholder={dato['type']}
                                                       name="type"/> : dato['type']}</th>
                                            <th>{modifi != null && modifi.code == dato.code ?
                                                <input onChange={handleChangeModifi} type="text" id="laboratory"
                                                       spellCheck="false"
                                                       placeholder={dato['laboratory']}
                                                       name="laboratory"/> : dato['laboratory']}</th>
                                            <th>{modifi != null && modifi.code == dato.code ?
                                                <input onChange={handleChangeModifi} type="text" id="code_pais"
                                                       spellCheck="false"
                                                       placeholder={dato['code_pais']}
                                                       name="code_pais"/> : dato['code_pais']}</th>
