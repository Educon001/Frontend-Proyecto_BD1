...
function Vacunada() {
    ...
    const modificar = async (dat) => {
        let result = await funciones.modificarFila('vacunada/' + dat.idpersona + '/' + dat.codevacuna + '/' + dat.codecentrov + '/' + dat.idpersonal + '/' + dat.datevacuna, modificable)
        return result
    }
                                ...
                                {personas.map((persona) => {
                                    return (
                                        ...
                                        <tr>
                                            ...
                                            <th>{modifi != null && modifi.idpersona == persona.idpersona
                                            && modifi.codevacuna == persona.codevacuna && modifi.codecentrov == persona.codecentrov
                                            && modifi.idpersonal == persona.idpersonal && modifi.datevacuna == persona.datevacuna ?
                                                <input onChange={handleChangeModifi} type="text" id="dosis"
                                                       spellCheck="false"
                                                       placeholder={persona['dosis']}
                                                       name="dosis"/> : persona['dosis']}</th>
                                            <th className="acciones">
                                                {modifi != null && modifi.idpersona == persona.idpersona
                                                && modifi.codevacuna == persona.codevacuna && modifi.codecentrov == persona.codecentrov
                                                && modifi.idpersonal == persona.idpersonal && modifi.datevacuna == persona.datevacuna ? <>
                                                    <Button
                                                        variant="contained"
